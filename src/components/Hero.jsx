...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col justify-center items-center px-6 md:px-12 bg-white dark:bg-black transition-colors duration-500"
    >
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-transparent dark:bg-black/60 transition-colors duration-500 pointer-events-none" />

      {/* Hero Card */}
      <div className="relative z-10 w-full h-[70vh] max-w-5xl rounded-3xl overflow-hidden shadow-2xl backdrop-blur-md group transition duration-500">
